...
import { ShieldCheck, FileText, AlertCircle, CheckCircle2, Clock, Download, Award, FileBarChart, TrendingUp, PackageCheck, Truck, AlertTriangle } from 'lucide-react';
...
const Compliance: React.FC = () => {
    ...
    const docData = React.useMemo(() => vehicles.map(vehicle => {
        const revTecnica = vehicle.nextService || '2024-12-15';
        ...
        return {
            ...
            perCirculacion: '2025-03-31', // Podría agregarse al modelo
            status
        };
    }), [vehicles]);
